...
class StaticObjectView(Drawable, ViewTools, GuiElement):
    ...
    def find_object(self, int x, int y):
        cdef Point m_position
    ...
    def on_mouse_motion(self, int x, int y, dx, dy):
    ...
    def on_mouse_press(self, int x, int y, int button, modifiers):
